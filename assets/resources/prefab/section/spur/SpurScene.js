...
cc.Class({
    ...
    onLoad: function () {
        cc.log("Spur - load", this.selectedUser);
        ...
        // 鞭策理由
        UserAPI.spurReason(function(msg, data) {
            if (data === null) {
    ...
    submitButtonClicked: function() {
        ...
        UserAPI.spur(this.selectedUser.user_id, this.selectedReason.reason_id, function(msg, data) {
            if (data === null) {
                return Toast.show(msg);
            }
            this.node.removeFromParent();
